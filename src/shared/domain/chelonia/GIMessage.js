...
export class GIMessage {
  ...
  static OP_ACTION_ENCRYPTED = 'ae' // e2-encrypted action
  ...
  // esline-disable-next-line camelcase
  static createV1_0 (
    contractID = null,
    previousHEAD = null,
    op,
    signatureGn = defaultSignatureFn) {
    const message = {
      version: '1.0.0',
      previousHEAD,
      contractID,
    ...
    //       do not ever regenerate this message using the constructor
